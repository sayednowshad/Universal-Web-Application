...
export function FireBase(){
    ...
    var PyYt = () => {
      navigate('/Backend_FireBase_Yt');
    };

    var navigate = useNavigate();

    var PyUd = () => {
      navigate('/Backend_FireBase_Udemy');
    };
    ...
    var PyGfg = () => {
      navigate('/Backend_FireBase_Gfg');
    };

    var navigate = useNavigate();

    var PyCo = () => {
      navigate('/Backend_FireBase_Coursera');
    };

    var navigate = useNavigate();
    var PyCodplat = () => {
        navigate('/Backend_FireBase_Codplat');
      }; 
