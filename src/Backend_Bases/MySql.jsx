...
export function MySQL(){
    ...
    var PyYt = () => {
      navigate('/Backend_Sql_Yt');
    };

    var navigate = useNavigate();

    var PyUd = () => {
      navigate('/Backend_Sql_Udemy');
    };
    ...
    var PyGfg = () => {
      navigate('/Backend_Sql_Gfg');
    };

    var navigate = useNavigate();

    var PyCo = () => {
      navigate('/Backend_Sql_Coursera');
    };

    var navigate = useNavigate();
    var PyCodplat = () => {
        navigate('/Backend_Sql_Codplat');
      }; 
