...
export function Api_op(){
    ...
    var ApiYt = () => {
      navigate('/Backend_Api_Yt');
    };

    var navigate = useNavigate();

    var ApiUd = () => {
      navigate('/Backend_Api_Udemy');
    };
    ...
    var ApiGfg = () => {
      navigate('/Backend_Api_Gfg');
    };

    var navigate = useNavigate();

    var ApiCo = () => {
      navigate('/Backend_Api_Coursera');
    };

    var navigate = useNavigate();
    var ApiCodplat = () => {
        navigate('/Backend_Api_Codplat');
      }; 
    ...
    return (
        ...
        {/* < ------------------------------------- 1 ------------------------------------------------ >*/}
            ...
            <button className="btn_html_yt" onClick={ApiYt} > Click Me </button>
            </div>
        ...
        {/* < ------------------------------------------ 2 ------------------------------------------------ >*/}
            ...
            <button className="btn_html_yt"  onClick = {ApiCo } > Click Me </button>
            </div>
            </div>
        ...
        {/* < ---------------------------------------- 3 ---------------------------------------------------- >*/}
            ...
            <button className="btn_html_yt" onClick = {ApiUd } > Click Me </button>
            </div>
            </div>
            ...
            <button className="btn_html_yt"  onClick = {ApiGfg } > Click Me </button>
            </div>
            </div>
            ...
            <button className="btn_html_yt" onClick = { ApiCodplat } > Click Me </button>
