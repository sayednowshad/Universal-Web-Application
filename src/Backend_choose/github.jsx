...
export function GitHub_op(){
    ...
    var GithubYt = () => {
      navigate('/Backend_GitHub_Yt');
    };

    var navigate = useNavigate();

    var GithubUd = () => {
      navigate('/Backend_GitHub_Udemy');
    };

    var navigate = useNavigate();

    var GithubGfg = () => {
      navigate('/Backend_GitHub_Gfg');
    };

    var navigate = useNavigate();

    var GithubCo = () => {
      navigate('/Backend_GitHub_Coursera');
    };

    var navigate = useNavigate();

    var GithubCodplat = () => {
        navigate('/Backend_GitHub_Codplat');
      }; 
    ...
    return (
        ...
        {/* < ------------------------------------- 1 ------------------------------------------------ >*/}
            ...
            <button className="btn_html_yt" onClick={GithubYt} > Click Me </button>
            </div>
        ...
        {/* < ------------------------------------------ 2 ------------------------------------------------ >*/}
            ...
            <button className="btn_html_yt"  onClick = {GithubCo } > Click Me </button>
            </div>
            </div>
        ...
        {/* < ---------------------------------------- 3 ---------------------------------------------------- >*/}
            ...
            <button className="btn_html_yt" onClick = {GithubUd } > Click Me </button>
            </div>
            </div>
            ...
            <button className="btn_html_yt"  onClick = {GithubGfg } > Click Me </button>
            </div>
            </div>
            ...
            <button className="btn_html_yt" onClick = { GithubCodplat } > Click Me </button>
