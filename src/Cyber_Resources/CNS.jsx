...
export function CNS(){
    ...
    var Yt = () => {
      navigate('/Cyber_CNS_Yt');
    };

    var navigate = useNavigate();

    var Ud = () => {
      navigate('/Cyber_CNS_Udemy'); 
    };
    ...
    var Co = () => {
      navigate('/Cyber_CNS_Coursera');
    };

    var navigate = useNavigate();

    var Gfg = () => {
      navigate('/Cyber_CNS_Gfg');
    };
    ...
    return (
        ...
        <p className="html_para"> These are the platforms for your <strong> Computer Networking System </strong> Study purpose. Utilize this and these are the recommended platforms to explore and gain knowledge for practice and do more, again this is not for any Promotions it is for the <strong> educational purpose </strong> to do more, explore all in shorten time.</p>
        ...
        {/* < ---------------------------------------- 3 ---------------------------------------------------- >*/}
            ...
            <button className="btn_html_yt"  onClick = {Gfg } > Click Me </button>
            </div>
            </div>
