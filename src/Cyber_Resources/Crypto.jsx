...
export function Crypto(){
    ...
    var Yt = () => {
      navigate('/Cyber_Crypto_Yt');
    };

    var navigate = useNavigate();

    var Ud = () => {
      navigate('/Cyber_Crypto_Udemy'); 
    };
    ...
    var Co = () => {
      navigate('/Cyber_Crypto_Coursera');
    };

    var navigate = useNavigate();

    var Gfg = () => {
      navigate('/Cyber_Crypto_Gfg');
    };
