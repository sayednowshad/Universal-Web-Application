export function CyberCommunity(props){
    ...
    var val5 = " ";
         ...
         return (
             ...
             <h1 className="html_yt_heading">These are the <strong style={{textDecoration : 'underline', color : 'blue'}}>Top 5 </strong>  Game Community Page That You can Refer  </h1>
