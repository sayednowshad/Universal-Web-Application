...
export function Hijacking(){

    var navigate = useNavigate();

    var Yt = () => {
      navigate('/Cyber_Hijacking_Yt');
    };

    var navigate = useNavigate();

    var Ud = () => {
      navigate('/Cyber_Hijacking_Udemy'); 
    };
    ...
    var Co = () => {
      navigate('/Cyber_Hijacking_Coursera');
    };

    var navigate = useNavigate();

    var Pdf = () => {
      navigate('/Cyber_Hijacking_Pdf');
    };
