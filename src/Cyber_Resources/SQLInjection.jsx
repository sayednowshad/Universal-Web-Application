...
export function SQLInjection(){
    ...
    var Yt = () => {
      navigate('/Cyber_SQLInjection_Yt');
    };

    var navigate = useNavigate();

    var Ud = () => {
      navigate('/Cyber_SQLInjection_Udemy');
    };
    ...
    var Co = () => {
      navigate('/Cyber_SQLInjection_Coursera');
    };

    var navigate = useNavigate();

    var Pdf = () => {
      navigate('/Cyber_SQLInjection_Pdf');
    };
