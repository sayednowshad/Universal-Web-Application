...
export function WebSecurity(){
    ...
    var Yt = () => {
      navigate('/Cyber_WebSecurity_Yt');
    };

    var navigate = useNavigate();

    var Ud = () => {
      navigate('/Cyber_WebSecurity_Udemy'); 
    };
    ...
    var Co = () => {
      navigate('/Cyber_WebSecurity_Coursera');
    };

    var navigate = useNavigate();

    var Pdf = () => {
      navigate('/Cyber_WebSecurity_Pdf');
    };
    ...
    return (
        ...
        <p className="html_para"> These are the platforms for your <strong> Application &  WebSecurity </strong> Study purpose. Utilize this and these are the recommended platforms to explore and gain knowledge for practice and do more, again this is not for any Promotions it is for the <strong> educational purpose </strong> to do more, explore all in shorten time.</p>
