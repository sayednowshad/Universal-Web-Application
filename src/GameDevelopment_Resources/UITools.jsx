...
export function UITools(){
    ...
    var Yt = () => {
      navigate('/Game_UITools_Yt');
    };

    // var navigate = useNavigate();

    // var Ud = () => {
    //   navigate('/Game_Unity_Udemy');
    // };
    ...
    // var Co = () => {
    //   navigate('/Game_Unity_Coursera');
    // };

    var navigate = useNavigate();

    var Websites = () => { // Doc = Websites 
      navigate('/Game_UITools_Doc');
    };
    ...
    return (
        ...
        {/* < ------------------------------------------ 2 ------------------------------------------------ >*/}
            ...
            <div className="container_html_pg" >  {/* Container For Websites.... */}
            ...
            <h5 style={{margin : '30px 0px 0px 30px' , fontFamily : 'Arial' , fontWeight : 'bold'}}> Websites &#9754;  </h5>
            <div className="butt_yt">
