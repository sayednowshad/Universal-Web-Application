export function HtmlBp(){
    ...
    return(
        ...
        <>
        <h1 className="html_gfg_heading">These are the <strong style={{textDecoration : 'underline', color : 'blue'}}>Top 7 </strong> recommended Main Projects that you can Do with this Project Ideas  </h1>
        ...
        <p className="vid">Project 1: Creating a Personal Portfolio Page
