...
export function Game(){
    ...
    var navigate = useNavigate(); 
    var Projects = () => {
      navigate('/Game_Projects'); 

    };

    var navigate = useNavigate(); 
    var Community = () => { 
      navigate('/Community_Group'); 
    ...
    <div className="front_container">
        ...
        <h2 className="fr_1"> Game Development </h2>
     ...
     <ul className="fr_list">
        ...
        <li className="fr_li"> Thanks &  Enjoy <strong> "Stay Hard &#x1F4AA;, Stay Consistently" </strong> </li>
            ...
            <div className="fr_butt">
                ...
                <button className="fr_butt_click" onClick={Unity} > Unity </button>
                <button className="fr_butt_click" onClick={Godot}> GoDot </button>
                <button className="fr_butt_click" onClick={Tools}> UI Tools </button>
                <button className="fr_butt_click" onClick={Projects}> Projects </button>
                <button className="fr_butt_click" onClick={Community}> Community Group </button> 
